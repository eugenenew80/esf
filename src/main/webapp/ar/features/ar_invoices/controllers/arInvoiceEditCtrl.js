angular.module("arApp")
	.controller("arInvoiceEditCtrl", function ($scope, $http, $uibModal, $uibModalInstance, urlParamsBuilder, handleActionService, dataService, descriptionService, form, action, currentElement) {		
