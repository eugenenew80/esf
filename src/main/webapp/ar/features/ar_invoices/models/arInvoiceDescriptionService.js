(function () {
    angular.module("arApp")
        .factory("arInvoiceDescriptionService", function ($filter, stateService, buttonBuilder, fieldBuilder, tableFieldBuilder, responsiveTableFieldBuilder) {
            ...
            var tableActionsDef = [
                
                {
                    ...
                    controllerMethod: {
                        name: "importFromExternal"
                    },

                    trigger: "button",
                    button: {
                        desc: "Импорт из ИСУ",
                        tooltip: "Импортировать новые СФ из ИСУ",
                ...
                
                {
                    ...
                    button: {
                        desc: "Экспорт в XML",
                        tooltip: "Экспортировать выденные СФ в файл XML",
                        classes: "btn btn-primary btn-xs",
                        style: "margin-left: 3px;",
                        glyphicon: "glyphicon",
                        disabled: false
